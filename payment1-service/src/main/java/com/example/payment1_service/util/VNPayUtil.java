package com.example.payment1_service.util;
...
public class VNPayUtil {
    ...
    public static String decodeUserId(String encodedUserId) {
        return new String(Base64.getDecoder().decode(encodedUserId), StandardCharsets.UTF_8);
    }
